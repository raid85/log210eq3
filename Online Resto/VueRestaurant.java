...
{  
	...
	VueRestaurant()
	{
		...
		controleur.setTexte(0, textAdresse.getText());
		controleur.setTexte(1, textTelephone.getText());
		controleur.setTexte(2, textZoneLivraison.getText());
		controleur.setTexte(3, textHeureOuverture.getText());
		controleur.setTexte(4, textHeureFermeture.getText());
